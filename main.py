...
### variant 1, default ###
T2K_ND280_UPGRADE_SOFT_SRC_DIRNAME = "t2k-nd280-upgrade-copied-node204"  ## working var. AAA
...
T2K_ND280_UPGRADE_SOFT_BLD_DIRNAME = "t2k-nd280-upgrade-copied-node204-build-main"  ## working var. AAA
### variant 1, default ###

### !!! ###
# T2K_ND280_UPGRADE_SOFT_SRC_DIRNAME = "t2k-nd280-upgrade-git" ## working var. BBB
...
# T2K_ND280_UPGRADE_SOFT_BLD_DIRNAME = "t2k-nd280-upgrade-git-node204-build-08" ## working var. BBB
# T2K_ND280_UPGRADE_SOFT_BLD_DIRNAME = "t2k-nd280-upgrade-git-node204-build-09"
### !!! ###
...
# ROOT_CERN_INS_DIR_NAME = "root-install-node204-01c"
# ROOT_CERN_INS_DIR_NAME = "root-install-node204-01"
...
if __name__ == '__main__':
    ...
    gun_position_list = [
        ...
        # (0.995, 0.5, -86.0, 'cm'),  # reflector !
        # (0.2375, 0.3, -86.0, 'cm'),  # hole Fz (center) !
        # (0.3, 0.3, -86.0, 'cm'),  # Fz (center) !
    ...
    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/",
    #     "filename": "test-NuE-anue_nue-00-.0.gtrac.root",
    # }

    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/",
    #     "filename": "test-NuE-anumu_numu-00-rootracker.root",
    # }

    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/",
    #     "filename": "test-NuE-anue_nue-01-rootracker.root",
    # }

    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/generated-00/genie-NuE-nue-00-22.05.2021/100000-events/",
    #     "filename": "100k_events-anue_nue-rootracker.root",
    # }

    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/generated-00/genie-NuE-numu-00-22.05.2021/100000-events/",
    #     "filename": "100k_events-anumu_numu-rootracker.root",
    # }
    
    # config = {
    #     "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/generated-00/genie-CCQE-nue-00-23.05.2021/1000-events/",
    #     "filename": "1k_events-CCQE-anue_nue-rootracker.root",
    # }

    config = {
        "Path2file": "/t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/generated-00/genie-CCQE-numu-00-23.05.2021/1000-events/",
        "filename": "1k_events-CCQE-anumu_numu-rootracker.root",
    }
    ...
    # python3 /t2k/users/shvartsman/T2KND280soft_/node204-new-scheme/main.py -a analize -anf CR1.C -sd <> -sf <>
